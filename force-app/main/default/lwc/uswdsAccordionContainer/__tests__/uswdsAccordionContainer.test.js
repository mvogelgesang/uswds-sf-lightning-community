...
describe("c-uswds-accordion-container", () => {
  ...
  it("Verify that the accordion container applies the correct CSS class based on the `accordionType` property.", () => {
    // Arrange
  ...
  it("Verify that the accordion container applies the correct `data-allow-multiple` attribute and classbased on the `allowMultipleSelectable` property.", () => {
    // Arrange
    const element = createElement("c-uswds-accordion-container", {
      is: UswdsAccordionContainer
    });
  ...
  it("Verify that the accordion container sets the `applyTopMargin` property correctly on its child sections.", () => {
    // Arrange
    const element = createElement("c-uswds-accordion-container", {
      is: UswdsAccordionContainer
    });
